...
impl State {
    ...
    pub fn handle_mouse_move(&mut self, mouse_pos: (f64, f64)) {
        self.camera_controller
            .handle_mouse_move(mouse_pos, &mut self.camera);
    }

    pub fn handle_mouse_wheel(&mut self, delta: f32) {
        self.camera_controller
            .handle_mouse_wheel(delta as f64, &mut self.camera);
    }
}
